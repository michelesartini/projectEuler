...
/**
 * Class that defines some known sieve for the prime number generation upon a
 * maximum value.
 * 
...
public class PrimeNumberSieve {
	 ...
	 * @return
	 */
	public List<Integer> eratosthenesSieve(Integer maxValue) {
	 ...
	 * O(N/log log N)
	 * 
	 * TODO Optimise the below implementation of the Atkin sieve
	 * 
	 * @param maxValue
	 * @return
	 */
	public List<Integer> atkinSieve(Integer maxValue) {
		List<Integer> primes = new ArrayList<Integer>();
