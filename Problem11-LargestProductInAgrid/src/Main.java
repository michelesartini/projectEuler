...
public class Main {
	...
	public static final int ADIACENT_NUMBERS = 4;
	...
	public static void main(String[] args) {
		...
		product = findLargestProductSingleThreaded();
		System.out.printf("Product: %8.0f \n", product);
		...
		product = findLargestProductMultiThreaded();
		System.out.printf("Product: %8.0f \n", product);
		end = System.currentTimeMillis();
		end = end - start;
		System.out.println("Multithreaded execution time: " + end + "(ms)");	
	}
	
	/**
	 * Single threaded algorithm that identifies the greatest product present in a matrix.
	 ...
	 * @return
	 */
	public static Double findLargestProductSingleThreaded() {
	...
	public static Double findLargestProductMultiThreaded() {
		...
		List<MatrixProductMultiThreaded> lst = new ArrayList<MatrixProductMultiThreaded>();
		for (int i = 0; i < numberOfThreads; i++) {
			String threadName = "Thread-" + i;
			lst.add(new MatrixProductMultiThreaded(threadName, matrix, i ,ROW, COL, ADIACENT_NUMBERS));
		}
