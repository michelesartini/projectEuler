...
/**
 * Returns the greatest product in a matrix N x M, where N is equal to the value present in ADIACENT_NUMBERS.
 * It implements the Callable interface so that when the execution is completed it is possible to retrieve the result.
 * 
 * How does it work?
 * Everytime a MatrixProductMultiThreaded object is instantiated, it receive a matrix that could be as follow:
 * 
 ...
 * 
 * It searches for the greatest product in a sub matrix N x M where M is equal to ADIACENT_NUMBERS, for example:
 * (It uses the row value passed in the constructor to identify the sub matrix)
 * 
 * 08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
 * 49 49 99 40 17 81 18 57 60 87 17 40 98 43 69 48 04 56 62 00
 * 81 49 31 73 55 79 14 29 93 71 40 67 53 88 30 03 49 13 36 65
